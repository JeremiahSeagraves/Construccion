 ...
 * @author juan
 */
public class ControladorPanelRelizarVenta {
    private static ControladorPanelRelizarVenta controladorPanelRelizarVenta = null;
    ...
    public static ControladorPanelRelizarVenta obtenerControladorPanelRealizarVenta(){
        if(controladorPanelRelizarVenta == null){
            controladorPanelRelizarVenta = new ControladorPanelRelizarVenta();
